...
public class OrderView {
    ...
    public void displayOrder() {
        while (true) {
            ...
            if (orders.isEmpty()) {
                ...
                // mengambil semua menu yang sudah di pesan oleh user
    ...
    // method untuk membuat dan menyimpan nota pembayaran pesanan dalam sebuah file teks
    ...
    // method untuk mencetak isi dari nota pembayaran yang telah disimpan dalam file teks
